...
public:
	...
	void Setup(double scx, double scy) {
		...
		textureUp.loadFromFile("CHIKAstraight.jpg");
		textureDown.loadFromFile("CHIKAback.jpg");
		textureLeft.loadFromFile("CHIKAleft.jpg");
		textureRight.loadFromFile("CHIKAright.jpg");
